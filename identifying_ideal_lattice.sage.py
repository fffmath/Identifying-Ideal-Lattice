...
_sage_const_10 = Integer(10); _sage_const_0 = Integer(0); _sage_const_1e6 = RealNumber('1e6'); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4)
import sys
import time
import logging
import csv
...
class LatticeGenerator:
    def __init__(self, dim, bound=_sage_const_10 , seed=None, max_attempts=_sage_const_10 ):
        self.dim = dim
        self.bound = bound
        self.seed = seed
